...
class Config:
    ...
    def __init__(self, config_file: str = None):
        ...
        self.llm_provider = os.getenv('LLM_PROVIDER', "chatglm3")
        self.fast_llm_model = os.getenv('FAST_LLM_MODEL', "chatglm3")
        self.smart_llm_model = os.getenv('SMART_LLM_MODEL', "chatglm3")
